...
const menu = (prefix, pushname) => {
    ...
    var ramadhan2k21 = new Date("December 31, 2021 00:00:00").getTime() 
...
Good ${salam} ${pushname}!
	...
	- Time : ${moment().utcOffset('1000').format('HH:mm:ss')} WIB -
	- Runtime : ${formater1(uptime1)} -

Akhir bulan : ${secondsToHms(hitungMundur)}

Link Grup AsunaBot : https://chat.whatsapp.com/LKhZRvlFeHRI7ilTiVKzct
...
const mess = {
             wait: 'Tunggu! Sedang Membuat Request Ke Server!',
			 group: 'this command can only be used in groups!',
			 admin: 'Otoritas terlalu rendah! Dibutuhkan Admin Untuk Mengakses ini!',
